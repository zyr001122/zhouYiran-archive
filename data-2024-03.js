const posts_202403 = [
  ...
  },
  {
    ...
    translatedText: "안녕 익연아! 요즘 학업 문제 때문에 정말 너무 지치고 불안해. 미래에 마주할 모든 것들이 두렵기도 하고... 헤헤, 그래도 다행히 난 긍정적인 편이야! 음.. 사실 내 긍정적인 에너지의 큰 부분은 너한테서 나와, 익연아! 드라마 《투라대륙2》와 《당아비분향니》 두 작품의 빡빡한 촬영과 홍보 스케줄 속에서 일이 네 시간의 전부를 차지했을 때, 모든 타임라인이 딱 맞아떨어지느라 네 몸은 이미 과부하 상태였잖아. 밥도 제대로 못 먹으면서 힘들다거나 괴롭다는 말 한마디 안 하더라. 문제가 생기면 다른 사람한테 털어놓아 짐을 얹어주기보단, 혼자 속으로 삼키고 소화해 내는 편이잖아. 예전엔 스스로를 성숙하고, 묵직하고, 낯을 가린다고 표현하더니 나중에는 '성숙'이라는 단어를 '유치함'으로 바꾸고 싶다고, 그저 매일매일 행복한 어린아이가 되고 싶다고 했지. 그러니 삶이 어떻게 안 힘들었겠어. 내 가수가 그저 힘들다고 말을 안 할 뿐이지... 네가 이렇게 큰 사랑을 받는 건 절대 우연이 아니라 한 걸음 한 걸음 성실하게 발을 내디뎌온 결과야! 마음속에 품은 그 뚝심과 열정이 사람을 참 끌리게 만들어. 네가 그렇게 멋지고 열심히 하니까 나도 더 자극받아서 열심히 노력해서 널 보러 갈 거야! 네가 거침없이 높이 올라가기를, 네 앞날이 늘 순탄하고 사업도 날로 번창하기를 바랄게. 내 책상 위에 있는 곰돌이 인형 사진 보여줄게. 친구들이 못생겼는데 귀엽대 ㅋㅋㅋㅋㅋㅋㅋ 그리고 요즘 내 일상은 책 읽고 공부하기📖 그리고 익연이 사진 수집하기야! 마지막으로 나의 대스타 주익연, 매일 행복해야 해! 네가 앞으로 나아갈 때 우린 항상 그 자리에 있을게! 꼭 열심히 노력해서 만나러 갈게!",
