const posts = [
  {
    ...
    translatedText: "나 이제 갈게 다들 일찍 쉬어 🧑‍🚀 다들 몸 잘 챙기고 나랑 너네 모두 모든 일이 순조롭기를 바라 댓글창의 행운의 잉어한테 빈 소원들이 다 이루어지면 좋겠다",
    images: [],
    comments: [
      {
        id: 101,
        ...
        translatedText: "소유욕 발동했어 지금 당장 뭐 하고 있는지 말해줘 @周翊然Tz",
      ...
      },
      {
        ...
        translatedText: "야, 댓글 읽고 있어? @周翊然Tz",
        images: ["images/cat-green.jpg"],
        actorReply: {
          originalText: "对的 人",
          translatedText: "맞아 읽는 중"
        }
      },
      {
        id: 103,
        ...
        translatedText: "이제 막 착륙해서 올리는 거라 좀 늦었어 😵",
        images: [],
        actorReply: null
      },
      {
      ...
      },
      {
        ...
        translatedText: "아가 만약에 샤오파랑 샤오마오가 이름표 뜯기를 하면 누가 이길 것 같아",
        images: ["images/ferrari-maotai.jpg"],
        actorReply: {
          originalText: "🤦 难到我了",
          translatedText: "🤦 날 난처하게 하네"
        }
      },
      {
        id: 107,
        ...
        translatedText: "오빠 사테가 오빠 이름표 뜯으려는데 오빠는 왜 앞으로 넘어졌어 (사테 미안 🙏)",
        images: ["images/variety-uncle.jpg"],
        actorReply: {
          originalText: "脑子宕机了…",
          translatedText: "머리가 멈춰서…"
        }
      },
      {
        id: 108,
        ...
        actorReply: {
          ...
          translatedText: "엄청 추워 아침 저녁으로는 겨우 4도 정도야"
        }
      },
      {
        id: 109,
        ...
        translatedText: "이 토마토 달걀 볶음이 고추 고기 볶음보다 비주얼이 더 좋아 보이는데 어떤 게 더 맛있어 🤤",
      ...
      },
      {
        ...
        translatedText: "내가 디자인한 네일아트 어때 오빠 요소도 많이 들어가 있어 예쁘지 🧑‍🚀",
      ...
      },
      {
        ...
        translatedText: "오빠 이것 봐 컴퓨터 과제로 그린 삼면도인데 어떤 행사 스타일링인지 맞춰봐 (엄청 쉬워) 하지만 내가 피부색 톤을 잘 못 잡아서 속상해 🫳🏻 칭찬해 줘",
        images: ["images/hair-pink.jpg"],
        actorReply: {
          originalText: "我猜是apm",
          translatedText: "내 추측엔 apm 행사 때"
        }
      },
      {
        id: 113,
        ...
        translatedText: "너 이 영상 편집하는 데 얼마나 걸렸어 어디 가서 배워온 거야 🐺",
      ...
      },
      {
        ...
        translatedText: "너 이번에 프랑스 가서 맛있게 먹은 거 있으면 올려서 보여줘 👀",
        images: ["images/crayon-shin.jpg"],
        actorReply: {
          originalText: "我自己做的饭好吃啊",
          translatedText: "내가 직접 요리한 밥이 맛있어"
        }
      },
      {
        id: 115,
        ...
        translatedText: "이 고양이 진짜 잘생겼다 프랑스 숙소에서 너희랑 같이 지내는 거야",
        images: ["images/cat.jpg"],
        actorReply: {
          originalText: "一睡醒就跑进来了 🤦",
          translatedText: "자고 깨자마자 뛰어 들어왔어 🤦"
        }
      },
      {
        id: 116,
      ...
      },
      {
        ...
        translatedText: "행운의 잉어를 봤으니 소원 빌어줘",
        images: ["images/fish-koi.jpg"],
        actorReply: {
          originalText: "🙏希望我和评论区的所有人都一切顺利！！！",
          translatedText: "🙏 나랑 댓글창의 모든 사람이 다 순조롭기를 바라"
        }
      },
      {
        id: 118,
      ...
      },
      {
        ...
        translatedText: "이 검고 어두운 건 뭐야",
        images: ["images/coal.jpg"],
        actorReply: {
          originalText: "煤炭啊 🤦",
          translatedText: "석탄이잖아 🤦"
        }
      },
      {
        id: 120,
      ...
      },
      {
        ...
        translatedText: "연연 만든 굴전 계란말이가 아주 맛있어 보여 😋",
      ...
      },
      {
        ...
        translatedText: "오빠 요즘 한 곡만 반복 재생하는 노래 있어",
        images: ["images/cat-meme.jpg"],
        actorReply: {
          originalText: "此时此刻 🎵",
          translatedText: "차시차각(此时此刻) 🎵"
        }
      },
      {
        id: 128,
        ...
        translatedText: "오빠 웍질해서 뒤집을 줄 알아 🤭",
        images: ["images/food-egg-drawing.jpg"],
        actorReply: {
          originalText: "难道没看到我预告中那快离地一米的翻面吗",
          translatedText: "내 예고편에서 땅에서 거의 1미터는 떠서 뒤집히는 거 못 봤어"
        }
      },
      {
        id: 129,
